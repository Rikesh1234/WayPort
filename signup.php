    ...
    <div class="registration-form">
        <form action="signupAction.php" method="POST">
            ...
            <div class="form-group">
                <input type="text" name="name" class="form-control item" id="name" placeholder="Full Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <button type="submit" name="signup" class="btn btn-block create-account">Create Account</button>
            </div>
            <div class="form-group text-center log">
                <a href="login.php">Alreday Have a account?</a>
            </div>
        </form>
